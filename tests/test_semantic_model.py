...
DERIVED_RES = [
    ...
    # A date dimension derived from a fact file READS that file and CREATES its own
    # columns from a list. Without this the month tables read as typing columns the
    # claims CSV has never had - which is true, and not a defect.
